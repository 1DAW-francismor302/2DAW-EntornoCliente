"use strict"
{
    ...
    // guardarElNombre(); // esto mandarlo como ejercicio.
        ...
        function colorGuardar () { 
                
        if(!getCookie('colorfondo')){
            let r = prompt("Introduce un numero del 0-255");
            let g = prompt("Introduce un numero del 0-255");
            let b = prompt("Introduce un numero del 0-255");
            
            document.body.style.backgroundColor= 'rgb('+r+','+g+','+b+')';

            setCookie('colorfondo',document.body.style.backgroundColor,7)
        } else {
